...
public class SortCommand implements Command {
	...
	public SortCommand(String key, String byPattern, Limit limit, String[] getPatterns, OrderType order, Boolean alpha, String destination, byte[] rawKey, byte[] rawByPattern, byte[][] rawGetPatterns,
		byte[] rawDestination) {
		this.key = key;
	...
	public String toString() {
		return "SortCommand{" + "key='" + key + '\'' + ", byPattern='" + byPattern + '\'' + ", limit=" + limit + ", getPatterns=" + Arrays.toString(getPatterns) + ", order=" + order + ", alpha="
			+ alpha + ", destination='" + destination + '\'' + '}';
	}
}