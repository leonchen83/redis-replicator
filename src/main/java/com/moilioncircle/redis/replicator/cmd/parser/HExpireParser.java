 ...
 * @since 3.12.0
 */
public class HExpireParser implements CommandParser<HExpireCommand> {

    @Override
    public HExpireCommand parse(Object[] command) {
        int idx = 1;
        ...
        return new HExpireCommand(key, fields, ex, existType, compareType);
    }
