 ...
 * @since 3.12.0
 */
public class HPExpireParser implements CommandParser<HPExpireCommand> {

    @Override
    public HPExpireCommand parse(Object[] command) {
        int idx = 1;
        ...
        return new HPExpireCommand(key, fields, ex, existType, compareType);
    }
