...
public class RdbBinaryParserTest {
    ...
    public void testParse() {
        ...
        assertEquals(253, ((ByteArrayMap) map.get("zipmap_with_big_values").getValue()).get("253bytes".getBytes()).length);
        assertEquals(254, ((ByteArrayMap) map.get("zipmap_with_big_values").getValue()).get("254bytes".getBytes()).length);
        assertEquals(255, ((ByteArrayMap) map.get("zipmap_with_big_values").getValue()).get("255bytes".getBytes()).length);
        assertEquals(300, ((ByteArrayMap) map.get("zipmap_with_big_values").getValue()).get("300bytes".getBytes()).length);
        assertEquals(20000, ((ByteArrayMap) map.get("zipmap_with_big_values").getValue()).get("20kbytes".getBytes()).length);
        ...
        List<byte[]> list = (ByteArrayList) map.get("force_linkedlist").getValue();
